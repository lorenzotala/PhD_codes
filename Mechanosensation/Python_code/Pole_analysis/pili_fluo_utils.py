...
def persentage_difference_biorep(df_in, nb_pili_threshold):
    ...
    for br in biorep:
        ...
        persentage_piliBright[br-1]=N_cells_morePiliBright[br-1]/n[br-1]*100
        persentage_piliDim[br-1]=N_cells_morePiliDim[br-1]/n[br-1]*100
        persentage_samepili[br-1]=N_cells_samePili[br-1]/n[br-1]*100
